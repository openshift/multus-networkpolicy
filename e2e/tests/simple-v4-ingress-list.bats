...
@test "check generated nftables rules" {
  ...
  run has_nftables_table "test-simple-v4-ingress-list" "pod-server"
  [ "$status" -eq  "0" ]

  run has_nftables_table "test-simple-v4-ingress-list" "pod-client-a"
  [ "$status" -eq  "1" ]

  run has_nftables_table "test-simple-v4-ingress-list" "pod-client-b"
  [ "$status" -eq  "1" ]

  run has_nftables_table "test-simple-v4-ingress-list" "pod-client-c"
  [ "$status" -eq  "1" ]
}
